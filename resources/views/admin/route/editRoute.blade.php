                ...
                <div class="card col-6 mt-3">
                    <div class="">
                        <h2 class="text-uppercase font-weight-bold p-4" style="color:palevioletred">
                            ...
                            <span style="margin-left: 50px; color: red;">Cập nhật tuyến đường</span>
                        </h2>
                    </div>
                    @if (session('success'))
                    ...
                    <div class=" card-body border ">
                        <form action="" enctype=" multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tg_dukien" name="tg_dukien" placeholder="3h20" value="{{$datas->tg_dukien}}">
                                @error('tg_dukien')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tansuat" name="tansuat" placeholder="chuyến/ngày" value="{{$datas->tansuat}}">
                                @error('tansuat')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="giave" name="giave" placeholder="ví dụ: 100000" value="{{$datas->giave}}">
                                @error('giave')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
