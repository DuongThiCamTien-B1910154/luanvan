            ...
            <div class="d-flex justify-content-between">
                <form class="d-flex align-items-center h-100 " action="">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control border-1 border-dark " placeholder="Tìm kiếm..." style="font-size: 15px;" name="search" value="">
                ...
                <tbody>
                    ...
                    <form action="" method="post">
                        <td class="text-primary btn">
                            <a href="{{asset('')}}"><i class="fa-solid fa-pen-to-square"></i></a>

                        </td>
                        <td class="text-danger btn">
                            @csrf
                            @method('delete')
                            <a href="{{asset('')}}" class="text-danger" onclick="return confirm('Bạn có chắc muốn xóa không?')">
