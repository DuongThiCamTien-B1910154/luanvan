                ...
                <div class="card col-6 mt-3">
                    <div class="">
                        <h2 class="text-uppercase font-weight-bold p-4" style="color:palevioletred">
                            ...
                            <span style="margin-left: 130px; color: red;">Thêm xe</span>
                        </h2>
                    </div>
                    @if (session('success'))
                    ...
                    <div class=" card-body border ">
                        <form action="" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bienso" name="bienso" placeholder="67AB-123.45">
                                @error('bienso')
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="file_upload" class="form-control" id="upload" value="" />
                            </div>
